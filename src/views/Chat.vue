<template>
  ...
  <b-modal  ref="usernamePopUp" id="modal-2" title="Enter username"
		body-bg-variant="dark" 
  		header-bg-variant="dark" 
  		footer-bg-variant="dark"
  ...
  >
	  <b-form-input id="usernameInput" v-model="username"></b-form-input>
		...
		<b-form @submit="sendMessage"	style="display: flex; flex-direction: column; justify-content: space-between; margin: auto; width: 75%;">
